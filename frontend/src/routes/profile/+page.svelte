<script>
	...
	let totalTasks = 0;
	let recentActivity = []; // Array to store recent activity
	...
	let calendarGrid = [];
	let groupedTasks = {}; // Tasks grouped by date

	// Fetch user data on mount
	onMount(async () => {
		// Fetch user data from authStore
	...
	<div class="mt-6">
		...
		<div class="mt-2">
			...
			<div class="mt-1 h-3 w-full rounded-full bg-gray-200">
				<div class="h-3 rounded-full bg-[#5042A5]" style={`width: ${completionPercentage}%`}></div>
			</div>
